...
(function () {
  ...
  function postureClass(t) {
    ...
    var multi = /^multiple|all three|three postures|simultaneous/.test(s)
  ...
  function wirePosture() {
    ...
    pills.forEach(function (pill) {
      ...
      if (k === 'all') pill.textContent = 'All ' + terr;
      else if (LBL[k]) pill.textContent = LBL[k] + ' (' + (counts[k] + counts.Multiple) + ')';
    ...
    console.log('[dd_v2_filters] posture counts (corrected): Nindra ' + counts.Nindra +
