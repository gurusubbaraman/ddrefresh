/* ==================================================================
   DD v2 — CANON: sets, categories, Alwar metadata   [2C.1a folded in]   CONSOLIDATED 2026-07-30, RE-BAKED 2026-08-01
   ------------------------------------------------------------------
...
(function () {
  ...
  window.DD_CANON_BAKED = '2026-08-01';
  ...
  /* ULAGALANTHA COMPLEX — corrected 2026-08-01 (Session 2C.3).
     The set previously held only [53, 54, 55], the three subsidiary
     shrines, and omitted #49 Thiru Ooragam — the principal shrine the
     complex is named after, and the 35-foot Trivikrama in the main
     sanctum. Wikipedia states the complex "houses four Divya Desams in
     its different precincts, namely, Tirukkaravanam, Tirukarakam,
     Tiruneerakam, and Tiruurakam, that last of which is present within
     the sanctum sanctorum of the main temple." The temple's own site
     lists the same four.

     The corpus had already recorded the fact three ways: all four sit
     at the identical coordinate 12.83917, 79.705; the town field of
     #53, #54 and #55 reads "INSIDE Ulagalantha Perumal Temple complex";
     and #49 carries the descriptive tag multi_divya_desam_complex. The
     Session M.1 coordinate audit reported the four-way stack and it was
     recorded as "genuinely co-located" without connecting it to canon
     membership. */
  var CANON = {
    "divya_kanchi": [
      46,
  ...
  var CAT_DESCRIPTIONS = {
    ...
    ulagalantha_complex: 'The four Divya Desams within the Ulagalantha Perumal complex, Big Kanchipuram',
  ...
  /* Pancha Pandava attribution, corrected in Session 2C.1a and baked
     here in the re-bake of 2026-08-01. #94 Thirunavay is NOT one of the
     five — it is the Mamankam site, and entered the set only because its
     purana wrongly claimed the Sahadeva attribution. The fifth member is
     #95 Thiruvanvandoor. Verified against the Wikipedia articles for
     Thrichittatt, Puliyur, Aranmula and Thrikodithanam, each of which
     lists the same five, and against garudaseva.org. */
  var PANCHA_PANDAVA_ATTRIBUTION = {
  ...
  window.DD_PANCHA_PANDAVA_ATTRIBUTION = PANCHA_PANDAVA_ATTRIBUTION;
  ...
  console.log('[dd_v2_canon] consolidated canon loaded (baked 2026-08-01). ' +
